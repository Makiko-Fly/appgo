...
const (
	...
	BestCompression    = cgzip.Z_BEST_COMPRESSION
	BestSpeed          = cgzip.Z_BEST_SPEED
	DefaultCompression = cgzip.Z_DEFAULT_COMPRESSION
	NoCompression      = cgzip.Z_NO_COMPRESSION
)
...
func newGzipResponseWriter(rw negroni.ResponseWriter, w *cgzip.Writer) negroni.ResponseWriter {
...
func Gzip(level int) *handler {
	...
	h.pool.New = func() interface{} {
		gz, err := cgzip.NewWriterLevel(ioutil.Discard, level)
		if err != nil {
			panic(err)
		}
		return gz
